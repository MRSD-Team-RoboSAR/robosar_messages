...
typedef struct _robosar_fms_StatusMessage { 
    uint32_t status_val; 
    char message[200]; 
} robosar_fms_StatusMessage;
...
typedef struct _robosar_fms_SensorData { 
    ...
    robosar_fms_StatusMessage status_msg_data; 
...
#define robosar_fms_StatusMessage_status_val_tag 1
#define robosar_fms_StatusMessage_message_tag    2
...
#define robosar_fms_SensorData_status_msg_data_tag 10
...
#define robosar_fms_StatusMessage_FIELDLIST(X, a) \
X(a, STATIC,   REQUIRED, UINT32,   status_val,        1) \
X(a, STATIC,   REQUIRED, STRING,   message,           2)
#define robosar_fms_StatusMessage_CALLBACK NULL
#define robosar_fms_StatusMessage_DEFAULT NULL
...
X(a, STATIC,   REQUIRED, MESSAGE,  status_msg_data,  10)
...
#define robosar_fms_SensorData_status_msg_data_MSGTYPE robosar_fms_StatusMessage
...
extern const pb_msgdesc_t robosar_fms_StatusMessage_msg;
...
#define robosar_fms_StatusMessage_fields &robosar_fms_StatusMessage_msg
...
#define robosar_fms_SensorData_size              8143
#define robosar_fms_StatusMessage_size           208
